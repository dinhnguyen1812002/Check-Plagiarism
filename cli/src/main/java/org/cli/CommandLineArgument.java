...
import org.checkplagiarism.NumberOfArgumentValues;
import org.checkplagiarism.clustering.ClusteringAlgorithm;
...
import static org.checkplagiarism.options.CPOptions.DEFAULT_SHOWN_COMPARISONS;
import static org.checkplagiarism.options.CPOptions.DEFAULT_SIMILARITY_THRESHOLD;
import static org.cli.Main.ADVANCED_GROUP;
import static org.cli.Main.CLUSTERING_GROUP_NAME;
...
public enum CommandLineArgument {
    ...
    LANGUAGE(
            new Builder("-l", String.class).defaultsTo(new org.language.java.language().getIdentifier() )
    ...
    RESULT_FOLDER(new Builder("-r", String.class).defaultsTo("itcoder")),
    ...
    public static final String DEFAULT_LANGUAGE_IDENTIFIER = new org.language.java.language().getIdentifier();
